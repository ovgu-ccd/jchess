...
class JChessAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(StringResources.MAIN.getString("about") + " " + StringResources.MAIN.getString("Application.title") + " " + StringResources.MAIN.getString("Application.version")); // NOI18N
        setModal(true);
        ...
        appTitleLabel.setText(StringResources.MAIN.getString("Application.title")); // NOI18N
        appTitleLabel.setName("appTitleLabel"); // NOI18N

        versionLabel.setFont(versionLabel.getFont().deriveFont(versionLabel.getFont().getStyle() | java.awt.Font.BOLD));
        versionLabel.setText(StringResources.MAIN.getString("versionLabel.text")); // NOI18N
        versionLabel.setName("versionLabel"); // NOI18N

        appVersionLabel.setText(StringResources.MAIN.getString("Application.version")); // NOI18N
        appVersionLabel.setName("appVersionLabel"); // NOI18N

        homepageLabel.setFont(homepageLabel.getFont().deriveFont(homepageLabel.getFont().getStyle() | java.awt.Font.BOLD));
        homepageLabel.setText(StringResources.MAIN.getString("homepageLabel.text")); // NOI18N
        homepageLabel.setName("homepageLabel"); // NOI18N

        appHomepageLabel.setText(StringResources.MAIN.getString("Application.homepage")); // NOI18N
        appHomepageLabel.setName("appHomepageLabel"); // NOI18N

        appDescLabel.setText(StringResources.MAIN.getString("appDescLabel.text")); // NOI18N
        appDescLabel.setName("appDescLabel"); // NOI18N

        imageLabel.setIcon(new ImageIcon("resource/" + StringResources.MAIN.getString("imageLabel.icon"))); // NOI18N
        imageLabel.setName("imageLabel"); // NOI18N

        vendorLabel1.setFont(vendorLabel1.getFont().deriveFont(vendorLabel1.getFont().getStyle() | java.awt.Font.BOLD));
        vendorLabel1.setText(StringResources.MAIN.getString("vendorLabel1.text")); // NOI18N
        vendorLabel1.setName("vendorLabel1"); // NOI18N

        appVendorLabel1.setName("appVendorLabel1"); // NOI18N

        appHomepageLabel1.setText(StringResources.MAIN.getString("appHomepageLabel1.text")); // NOI18N
        appHomepageLabel1.setName("appHomepageLabel1"); // NOI18N

        appHomepageLabel2.setText(StringResources.MAIN.getString("appHomepageLabel2.text")); // NOI18N
        ...
        vendorLabel2.setText(StringResources.MAIN.getString("vendorLabel2.text")); // NOI18N
        vendorLabel2.setName("vendorLabel2"); // NOI18N

        appHomepageLabel3.setText(StringResources.MAIN.getString("appHomepageLabel3.text")); // NOI18N
